...
export default function BrandBadge() {
  ...
  return (
    <a
      href={appDeepLink}
      onClick={handleClick}
      className="inline-flex items-center gap-2 border border-white/20 text-white/80 hover:text-white transition-all text-[10px] tracking-wider uppercase font-mono px-4 py-2 bg-white/[0.05] rounded-full backdrop-blur-sm"
    >
